...
plot 'output.csv' using 2:xtic(1) title 'voltage' with lines,\
	 'output.csv' using 3:xtic(1) title 'MainDiagonal'  with lines,\
	 'output.csv' using 4:xtic(1) title 'B vector' with lines axes x1y2
set output 'simulation_viz_voltage.png'
replot


plot 'output.csv' using 11:xtic(1) title 'Iteration saving' with lines,\
	 'output.csv' using 13:xtic(1) title 'Speedup' with lines axes x1y2
